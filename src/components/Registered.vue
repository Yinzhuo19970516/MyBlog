<template>
      <div class="row">
        <div class="col-md-4 offset-md-4 floating-box">
          ...
          <button type="submit" class="btn btn-lg btn-primary btn-block" v-on:click.prevent="post">
...
<style scoped>
.thumbnail { width: 170px; margin-top: 10px;margin-bottom: 10px; cursor: pointer;}
